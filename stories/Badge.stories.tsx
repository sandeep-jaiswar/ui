...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "iOS-inspired badge component for notifications, status indicators, and labels. Supports various styles, sizes, and formatting options.",
      },
    },
  },
  tags: ["autodocs"],
...
export const WithButton: Story = {
  render: () => (
    <div className="relative inline-block">
      ...
      <Badge variant="primary" size="small" className="absolute -right-2 -top-2">
        3
      </Badge>
    </div>
  ),
  ...
  render: () => (
    <div className="relative inline-block">
      <Avatar
        ...
        size="large"
      />
      <Badge variant="success" dot size="medium" className="absolute right-0 top-0" />
    </div>
  ),
  parameters: {
    docs: {
...
export const NavigationTabs: Story = {
  render: () => (
    <div className="flex gap-1 rounded-ios bg-fill-secondary p-1 dark:bg-fill-secondary-dark">
      <div className="flex items-center gap-2 rounded-ios-sm bg-background-primary px-3 py-2 dark:bg-background-tertiary-dark">
...
export const StatusIndicators: Story = {
  render: () => (
    <div className="max-w-sm space-y-3">
      <div className="flex items-center justify-between rounded-ios bg-fill-quaternary p-3 dark:bg-fill-quaternary-dark">
      ...
      <div className="space-y-6">
        <div className="space-y-4">
          ...
          <div className="flex gap-2">
            <Button size="small" variant="secondary" onClick={() => setCount(Math.max(0, count - 1))}>
              -1
            </Button>
            <Button size="small" variant="secondary" onClick={() => setCount(count + 1)}>
              +1
            </Button>
            <Button size="small" variant="ghost" onClick={() => setCount(0)}>
              Clear
            </Button>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="relative inline-block">
            <Avatar initials="JD" />
            {showDot && <Badge variant="success" dot size="medium" className="absolute right-0 top-0" />}
          </div>
          <Button size="small" variant="secondary" onClick={() => setShowDot(!showDot)}>
            Toggle Status
          </Button>
        </div>
      </div>
