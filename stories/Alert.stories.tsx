...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "iOS-inspired alert component following Apple's alert design patterns. Supports both alert dialogs and action sheets.",
      },
    },
  },
  tags: ["autodocs"],
  ...
  render: () => {
    ...
    return (
      <div className="space-y-4">
        ...
        <Alert visible={alertVisible} onClose={() => setAlertVisible(false)} {...getAlertProps()} />
      </div>
    )
  },
  parameters: {
      ...
      <div className="max-w-sm space-y-6">
        ...
        <div className="space-y-4">
          <input
            ...
            className="w-full rounded-ios border p-3"
          />
          <input
            type="password"
        ...
        <Alert
          ...
          actions={[{ label: "OK", onPress: () => setShowAlert(false) }]}
