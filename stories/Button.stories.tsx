...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "iOS-inspired button component following Apple's Human Interface Guidelines. Supports multiple variants, sizes, and states with proper accessibility features.",
      },
    },
  },
  tags: ["autodocs"],
  ...
  render: () => {
    ...
    return (
      <div className="flex flex-col items-center gap-4">
        <div className="font-semibold text-ios-title-2">Count: {count}</div>
        <Button onClick={handleIncrement} loading={loading} startIcon={<PlusIcon />}>
