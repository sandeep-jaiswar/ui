...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'iOS-inspired card component following Apple\'s design guidelines. Provides flexible container for content with various styling options.',
      },
    },
  },
  tags: ['autodocs'],
...
export const NoPadding: Story = {
  args: {
    padding: 'none',
    children: (
      <div className="p-4 bg-systemBlue-50 dark:bg-systemBlue-900/20">
...
export const SmallPadding: Story = {
  args: {
    padding: 'small',
    children: (
      <Typography variant="body">Small padding (12px)</Typography>
    ),
  },
};
...
export const MediumPadding: Story = {
  args: {
    padding: 'medium',
    children: (
      <Typography variant="body">Medium padding (16px)</Typography>
    ),
  },
};
...
export const LargePadding: Story = {
  args: {
    padding: 'large',
    children: (
      <Typography variant="body">Large padding (24px)</Typography>
    ),
  },
};
    ...
    <Card padding="none" className="max-w-sm" interactive>
      ...
      <div className="p-4 space-y-2">
        ...
        <div className="flex items-center justify-between pt-2">
          <Typography variant="title3" color="system">$299</Typography>
