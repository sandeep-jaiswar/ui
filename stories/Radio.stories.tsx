...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'iOS-inspired radio component following Apple\'s design patterns. Use RadioGroup for managing multiple radio buttons.',
      },
    },
  },
  tags: ['autodocs'],
