...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "iOS-inspired avatar component for displaying user profile pictures with fallback options and online status indicators.",
      },
    },
  },
  tags: ["autodocs"],
  ...
  render: () => (
    <div className="flex items-center gap-4">
      <div className="text-center">
        ...
        <Typography variant="caption2" className="mt-1">
          Small
        </Typography>
      </div>
      <div className="text-center">
  ...
  render: () => (
    <div className="max-w-sm space-y-3">
      {[
        ...
        <div
          key={index}
          className="flex items-center gap-3 rounded-ios p-2 hover:bg-fill-quaternary dark:hover:bg-fill-quaternary-dark"
        >
          <Avatar initials={user.initials} online={user.online} backgroundColor={`hsl(${index * 90}, 60%, 50%)`} />
          <div>
  ...
  render: () => (
    <div className="flex -space-x-2">
      ...
      <Avatar
        ...
        className="border-2 border-background-primary dark:border-background-primary-dark"
      />
      <div className="flex h-10 w-10 items-center justify-center rounded-full border-2 border-background-primary bg-fill-secondary dark:border-background-primary-dark dark:bg-fill-secondary-dark">
        <Typography variant="caption1" color="secondary">
          +5
        </Typography>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="flex gap-4">
          {users.map((user, index) => (
            <div
              key={index}
              className={`cursor-pointer rounded-ios p-2 text-center transition-colors ${
                selectedUser === index
