  ...
  render: () => (
    <div className="flex items-center gap-8">
      <div className="text-center">
        <Spinner size="small" />
        <Typography variant="caption2" className="mt-2">Small</Typography>
      </div>
      <div className="text-center">
        <Spinner size="medium" />
        <Typography variant="caption2" className="mt-2">Medium</Typography>
      </div>
      <div className="text-center">
        <Spinner size="large" />
        <Typography variant="caption2" className="mt-2">Large</Typography>
      </div>
    </div>
  ),
  parameters: {
...
export const AllColors: Story = {
  render: () => (
    <div className="grid grid-cols-3 gap-6">
      <div className="text-center">
        <Spinner color="blue" />
        <Typography variant="caption2" className="mt-2">Blue</Typography>
      </div>
      <div className="text-center">
        <Spinner color="green" />
        <Typography variant="caption2" className="mt-2">Green</Typography>
      </div>
      <div className="text-center">
        <Spinner color="orange" />
        <Typography variant="caption2" className="mt-2">Orange</Typography>
      </div>
      <div className="text-center">
        <Spinner color="red" />
        <Typography variant="caption2" className="mt-2">Red</Typography>
      </div>
      <div className="text-center">
        <Spinner color="purple" />
        <Typography variant="caption2" className="mt-2">Purple</Typography>
      </div>
      <div className="text-center">
        <Spinner color="gray" />
        <Typography variant="caption2" className="mt-2">Gray</Typography>
      </div>
    </div>
  ),
  parameters: {
