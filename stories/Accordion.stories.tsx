  ...
  render: () => (
    <Accordion>
      ...
      <AccordionItem title="What is TypeScript?">
        TypeScript is a programming language developed by Microsoft that builds on JavaScript by adding static type
        definitions.
      </AccordionItem>
...
export const DefaultExpanded: Story = {
  render: () => (
    <Accordion>
      ...
      <AccordionItem title="Collapsed by default">This accordion item is collapsed by default.</AccordionItem>
    </Accordion>
  ),
}
...
export const WithDisabled: Story = {
  render: () => (
    <Accordion>
      <AccordionItem title="Normal item">This is a normal accordion item.</AccordionItem>
...
export const Separated: Story = {
  render: () => (
    <Accordion variant="separated">
      <AccordionItem title="First section">Content for the first section.</AccordionItem>
      <AccordionItem title="Second section">Content for the second section.</AccordionItem>
      <AccordionItem title="Third section">Content for the third section.</AccordionItem>
    </Accordion>
  ),
}
  ...
  render: () => {
    ...
    return (
      <div className="space-y-4">
        <div className="text-sm text-label-secondary">Expanded items: {expandedItems.join(", ") || "None"}</div>
