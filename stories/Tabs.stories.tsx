    ...
    const dynamicItems = [
      {
        ...
        content: (
          <div className="p-4">
            <h3 className="mb-2 font-semibold">Dynamic Tab 1</h3>
      ...
      },
      {
        ...
        content: (
          <div className="p-4">
            <h3 className="mb-2 font-semibold">Dynamic Tab 2</h3>
            <button onClick={() => setActiveTab("tab3")} className="rounded bg-systemBlue-500 px-3 py-1 text-white">
              Switch to Tab 3
            </button>
          </div>
        ),
      },
      {
        ...
        content: (
          <div className="p-4">
            <h3 className="mb-2 font-semibold">Dynamic Tab 3</h3>
