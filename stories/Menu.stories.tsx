    ...
    return (
      <div className="grid grid-cols-2 gap-8 p-8">
        <Menu
          ...
          trigger={
            <Button onClick={() => setOpenMenu(openMenu === 'bottom-left' ? null : 'bottom-left')}>
              Bottom Left
            </Button>
          }
        />
        ...
        <Menu
          ...
          position="top-left"
          trigger={
            <Button onClick={() => setOpenMenu(openMenu === 'top-left' ? null : 'top-left')}>
              Top Left
            </Button>
          }
        />
        ...
        <Menu
          ...
          position="top-right"
          trigger={
            <Button onClick={() => setOpenMenu(openMenu === 'top-right' ? null : 'top-right')}>
              Top Right
            </Button>
          }
        />
