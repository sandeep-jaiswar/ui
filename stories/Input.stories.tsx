...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'iOS-inspired input component with various styles, states, and features. Supports icons, validation, and different variants.',
      },
    },
  },
  tags: ['autodocs'],
      ...
      <div className="space-y-6 w-80">
        ...
        <div className="mt-6 p-4 bg-fill-quaternary dark:bg-fill-quaternary-dark rounded-ios">
          ...
          <Typography variant="footnote" color="secondary">
            Valid: {Object.keys(errors).length === 0 && Object.values(formData).every(v => v.length > 0) ? 'Yes' : 'No'}
          </Typography>
        </div>
      </div>
    );
