...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'iOS-inspired progress bar component for showing task completion, loading states, and progress indicators.',
      },
    },
  },
  tags: ['autodocs'],
...
export const AllSizes: Story = {
  render: () => (
    <div className="space-y-6 w-80">
      <div>
        <Typography variant="subhead" className="mb-2">Small</Typography>
        <ProgressBar size="small" value={65} showLabel />
      </div>
      <div>
        <Typography variant="subhead" className="mb-2">Medium</Typography>
        <ProgressBar size="medium" value={65} showLabel />
      </div>
      <div>
        <Typography variant="subhead" className="mb-2">Large</Typography>
