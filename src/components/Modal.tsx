      ...
      >
        ...
        <div
          ...
          className={`
            ...
            rounded-ios-xl shadow-modal max-h-full overflow-hidden
        ...
        >
          ...
          {(title || showCloseButton) && (
            <div className="flex items-center justify-between p-6 border-b border-separator-nonOpaque dark:border-separator-nonOpaque-dark">
              {title && (
                <h2 
                  id="modal-title"
                  className="text-ios-headline font-semibold text-label-primary dark:text-label-primary-dark"
                >
                  {title}
                </h2>
              )}
