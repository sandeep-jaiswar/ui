            ...
            <div className={cn("flex items-center space-x-2", disabled && "pointer-events-none")}>
                <div className="relative flex items-center">
                    <input
                        ...
                        className={cn(
                            "peer appearance-none rounded border bg-white transition-all duration-200 checked:border-transparent checked:bg-current focus:outline-none focus:ring-2 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50",
                    ...
                    <svg
                        className={cn(
                            "pointer-events-none absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-white opacity-0 transition-opacity duration-200 peer-checked:opacity-100",
