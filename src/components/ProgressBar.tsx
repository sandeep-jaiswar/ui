      ...
      <div className={`space-y-2 ${className}`} data-testid={testId} {...props}>
        {displayLabel && (
          <div className="flex justify-between items-center">
            <span className="text-ios-footnote text-label-secondary dark:text-label-secondary-dark">
              {displayLabel}
            </span>
            {showLabel && !label && (
        ...
        <div
          ref={ref}
          className={`w-full bg-fill-tertiary dark:bg-fill-tertiary-dark rounded-full overflow-hidden ${sizeStyles[size]}`}
          role="progressbar"
