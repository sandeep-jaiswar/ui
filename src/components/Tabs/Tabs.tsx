  ...
  ({ children, className, value, ...props }, ref) => {
    ...
    return (
      <div
        ...
        tabIndex={0}
        className={cn(
          "mt-2 ring-offset-white focus-visible:ring-2 focus-visible:ring-gray-950 focus-visible:ring-offset-2 focus-visible:outline-none dark:ring-offset-gray-950",
          className
        )}
        {...props}
      >
