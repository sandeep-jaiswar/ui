...
export const Radio = React.forwardRef<HTMLInputElement, RadioProps>(
  ({
    ...
    const colorStyles = {
      ...
      green: 'checked:bg-systemGreen-500 checked:border-systemGreen-500 dark:checked:bg-systemGreen-600 dark:checked:border-systemGreen-600',
      orange: 'checked:bg-systemOrange-500 checked:border-systemOrange-500 dark:checked:bg-systemOrange-600 dark:checked:border-systemOrange-600',
      ...
      purple: 'checked:bg-systemPurple-500 checked:border-systemPurple-500 dark:checked:bg-systemPurple-600 dark:checked:border-systemPurple-600'
    };
    ...
    return (
      <label className={`flex items-center gap-3 cursor-pointer ${labelPosition === 'left' ? 'flex-row-reverse' : ''} ${disabled ? 'cursor-not-allowed' : ''}`}>
        {radioElement}
        <span className="text-ios-body text-label-primary dark:text-label-primary-dark select-none">
          {label}
        </span>
      </label>
    );
