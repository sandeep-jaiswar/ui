...
export const NavigationMenuItemWithValue = ({ children, value, ...props }: React.ComponentProps<typeof NavigationMenuItem> & { value: string }) => {
    ...
    ({ children, className, value, ...props }, ref) => {
        ...
        return (
            <div
                ref={ref}
                className={cn(
                    "absolute left-0 top-full w-full md:absolute md:w-auto",
                    "mt-1.5 overflow-hidden rounded-md border bg-white shadow-lg dark:bg-gray-950 dark:border-gray-800",
