...
export const TextField = React.forwardRef<HTMLInputElement, TextFieldProps>(
  ({ label, error, helperText, className, onChange, value, variant = 'light', ...props }, ref) => {
    ...
    const stateStyles = error
      ...
      : variantStyles; // Use variant styles if no error

    const disabledStyles = props.disabled ? 'opacity-50 cursor-not-allowed bg-gray-100 dark:bg-gray-700 dark:text-gray-400' : '';
