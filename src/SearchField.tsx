      ...
      <div className={`flex items-center gap-2 ${fullWidth ? 'w-full' : ''}`}>
        <div className="relative flex-1">
          ...
          {showClear && (
            <button
              type="button"
              onClick={handleClear}
              className="absolute right-3 top-1/2 transform -translate-y-1/2 text-label-tertiary dark:text-label-tertiary-dark hover:text-label-secondary dark:hover:text-label-secondary-dark transition-colors"
        ...
        {showCancelButton && (
          <button
            ...
            className="text-ios-body text-systemBlue-500 dark:text-systemBlue-400 hover:text-systemBlue-600 dark:hover:text-systemBlue-300 transition-colors px-2"
          >
            Cancel
          </button>
        )}
