...
export const FloatingActionButton = React.forwardRef<HTMLButtonElement, FloatingActionButtonProps>(
  ({
    ...
    const colorStyles = {
      ...
      green: 'bg-systemGreen-500 hover:bg-systemGreen-600 active:bg-systemGreen-700 dark:bg-systemGreen-600 dark:hover:bg-systemGreen-700',
      orange: 'bg-systemOrange-500 hover:bg-systemOrange-600 active:bg-systemOrange-700 dark:bg-systemOrange-600 dark:hover:bg-systemOrange-700',
      red: 'bg-systemRed-500 hover:bg-systemRed-600 active:bg-systemRed-700 dark:bg-systemRed-600 dark:hover:bg-systemRed-700',
      purple: 'bg-systemPurple-500 hover:bg-systemPurple-600 active:bg-systemPurple-700 dark:bg-systemPurple-600 dark:hover:bg-systemPurple-700'
    };
    ...
    return (
      <button
        ...
        className={`
          ...
          ${colorStyles[color]} text-white rounded-full shadow-ios-3
          flex items-center justify-center transition-all duration-200 ease-ios
