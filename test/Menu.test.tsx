...
describe("Menu", () => {
  it("renders trigger when closed", () => {
    render(<Menu items={mockItems} open={false} onClose={() => {}} trigger={<button>Menu</button>} testId="menu" />)
    expect(screen.getByText("Menu")).toBeInTheDocument()
  })

  it("renders menu items when open", () => {
    render(<Menu items={mockItems} open={true} onClose={() => {}} testId="menu" />)
  ...
  it("calls onClose when item is clicked", () => {
    ...
    render(<Menu items={mockItems} open={true} onClose={handleClose} testId="menu" />)
