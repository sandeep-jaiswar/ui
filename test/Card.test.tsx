...
describe("Card", () => {
  ...
  it("passes through additional props", () => {
    render(
      <Card aria-label="Custom label" data-custom="value">
        Props test
      </Card>
    )
  ...
  it("combines all classes correctly", () => {
    render(
      <Card variant="grouped" padding="large" interactive className="extra-class">
        All styles
      </Card>
    )
    const card = screen.getByText("All styles")
    expect(card).toHaveClass("card-ios", "card-grouped", "p-6", "cursor-pointer", "extra-class")
  })
})
