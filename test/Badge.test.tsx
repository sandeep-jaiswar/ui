...
describe("Badge", () => {
  ...
  it("passes through additional props", () => {
    render(
      <Badge aria-label="Notification count" data-custom="value">
        5
      </Badge>
    )
    const badge = screen.getByText("5")
  ...
  it("combines all classes correctly", () => {
    render(
      <Badge variant="success" size="large" shape="rounded" className="extra-class">
        Combined
      </Badge>
    )
    const badge = screen.getByText("Combined")
    expect(badge).toHaveClass("badge-ios", "bg-systemGreen-500", "px-2.5", "py-1", "rounded-ios-sm", "extra-class")
  })
})
