...
describe("Avatar", () => {
  ...
  it("applies custom background and text colors for initials", () => {
    render(<Avatar initials="AB" backgroundColor="#FF0000" textColor="#FFFFFF" testId="colored-avatar" />)
  ...
  it("does not apply background color when image is provided", () => {
    render(<Avatar src="https://example.com/avatar.jpg" backgroundColor="#FF0000" testId="image-avatar" />)
  ...
  it("applies background color only when showing initials", () => {
    render(<Avatar initials="AB" backgroundColor="#FF0000" testId="initials-avatar" />)
