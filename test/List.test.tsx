...
describe("ListItem", () => {
  ...
  it("renders with left and right content", () => {
    render(
      <ListItem leftContent={<span>Left</span>} rightContent={<span>Right</span>} testId="item">
        Center
      </ListItem>
    )
  ...
  it("handles click events", () => {
    ...
    render(
      <ListItem onClick={handleClick} testId="item">
        Clickable
      </ListItem>
    )
  ...
  it("does not handle clicks when disabled", () => {
    const handleClick = vi.fn()
    render(
      <ListItem onClick={handleClick} disabled testId="item">
        Disabled
      </ListItem>
    )
