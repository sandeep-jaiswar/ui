...
describe("TextArea", () => {
  ...
  it("renders with label and helper text", () => {
    render(<TextArea label="Description" helperText="Enter a detailed description" testId="textarea" />)
    expect(screen.getByText("Description")).toBeInTheDocument()
    expect(screen.getByText("Enter a detailed description")).toBeInTheDocument()
  })

  it("shows error text when state is error", () => {
    render(<TextArea state="error" errorText="This field is required" testId="textarea" />)
